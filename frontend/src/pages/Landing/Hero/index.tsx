...
import logoGreen from "assets/images/ecology-green-cities-help-the-world-with-eco-friendly-concept-ideas-free-vector-removebg-preview.png";
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            ...
            <p className="mt-6 text-lg text-gray-600">
              Ecoverse is an innovative energy community platform that bridges
